...
Results:
    Runtime: 56 ms, faster than 96.30% of Python3 online submissions for Two Sum.
    Memory Usage: 16 MB, less than 6.61% of Python3 online submissions for Two Sum.
"""
...
class Solution:
    def twoSum(self, nums: list[int], target: int) -> list[int]:
        ...
        indices = [0] * 2  # makes a list only two items long in terms of used memory
        ...
        # But, anyway, description says that order doesn't matter.
        return indices
